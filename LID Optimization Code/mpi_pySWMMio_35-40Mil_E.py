...
# # Calculating Rain Garden Costs
    ...
    for subbasin in subbasin_attributes.index:
        subbasin_attributes.at[subbasin,'RainGarden_Costs'] = subbasin_attributes.at[subbasin,'Updated_RainGarden_ImpArea_Treated'] * 33.27
...
borg.setEpsilons(0.01)

0
result = borg.solveMPI(maxEvaluations=150000,runtime='mpi_pySWMMio_35-40Mil_E_pareto.runtime', frequency = 1500)


if result:

        # Create/write objective values and decision variable values to files in folder "sets", 1 file per seed.
    f = open('mpi_pySWMMio_35-40Mil_E_pareto.set', 'w')
    ...
    #     subbasin_attributes_list[sol].to_csv(r"/sfs/lustre/bahamut/scratch/rsh6pb/C/Borg/Borg-1.8/Borg Results/35-40 Mil/35-40MilSol_E_#{}.csv".format(sol))
