...
def pySWMMio(*vars):
    ...
    swmmio_altered_inp_file_name = (r"/SWMMIO_Altered_INPUTS/35-40 Mil")
...
# # Calculating Grass Swale Costs
    ...
    subbasin_attributes.to_csv(r"/Altered_SWMM_Input/temp_export_file_"+random_number+".csv")        
    temp_SB_csv = pd.read_csv(r"/Altered_SWMM_Input/temp_export_file_"+random_number+".csv")
...
# _________________Get average peak flow across 10 stream reaches_____________________________________________________________
 ...
 # _________  # Get Total Runoff Score
    ...
    os.remove(r"/Altered_SWMM_Input/temp_export_file_"+random_number+".csv")
...
if result:
    ...
    # Create/write objective values and decision variable values to files in folder "sets".
